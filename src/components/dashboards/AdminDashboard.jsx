...
const AdminDashboard = () => {
  ...
  const userManagement = [
    { id: 1, name: "Dr. Sarah Wilson", role: "Placement Officer", department: "CSE", status: "active", lastLogin: "2024-01-12" },
    { id: 2, name: "Prof. Raj Patel", role: "Placement Officer", department: "ECE", status: "active", lastLogin: "2024-01-11" },
    { id: 3, name: "Ms. Anita Singh", role: "Admin", department: "IT", status: "inactive", lastLogin: "2024-01-08" }
  ];
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 space-y-4">
        ...
        <div className="space-y-3">
          {userManagement.map((user) => (<Card key={user.id} className="card-elevated p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
